...
const chooseMovieMenu = async (list: Array<any>, origin: string) => {
  try {
    const askMenuOption = await prompts({
      type: "number",
      name: "position",
...
const listMoviesMenu = async (list: Array<any>, origin: string) => {
  try {
    log(
      chalk.bold.italic.underline(
...
const summaryMovieMenu = async (list: Array<any>, origin: string) => {
  try {
    log(
      chalk.bold.italic.underline(
